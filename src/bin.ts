...
export const handleFileGeneration1 = async function (dslFile:string) {

}
export const handleFileGeneration = async function (dslFile:string, format:IValidFormat, outputPath:string) {
	try {
		validateArgs();
 ...
 * (async () => {
	...
	await handleFileGeneration(dslFile, format, outputPath);
})();
 *
 * **/
